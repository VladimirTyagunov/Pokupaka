package com.pokupaka.ui.views.admin;
...
import com.pokupaka.backend.service.UserService;
...
import static com.pokupaka.ui.utils.PokupakaAppConst.PAGE_USERS;

@Route(value = PAGE_USERS, layout = MainLayout.class)
@PageTitle(PokupakaAppConst.TITLE_USERS)
@Secured(Role.ADMIN)
public class UsersView extends AbstractPokupakaCrudView<User> {
