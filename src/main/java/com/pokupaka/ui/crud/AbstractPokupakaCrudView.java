...
import com.pokupaka.ui.components.SearchBar;
import com.pokupaka.ui.utils.TemplateUtil;
...
public abstract class AbstractPokupakaCrudView<E extends AbstractEntity> extends Crud<E>
    ...
    public AbstractPokupakaCrudView(Class<E> beanType, FilterableCrudService<E> service,
