...
import com.pokupaka.testbench.elements.ui.UsersViewElement;
...
public class UsersViewIT extends AbstractIT<UsersViewElement> {
	...
	protected UsersViewElement openView() {
		ProductsViewUiElements storefront = openLoginView().login("admin@vaadin.com", "admin");
	...
	public void accessDenied() {
		ProductsViewUiElements storefront = openLoginView().login("barista@vaadin.com", "barista");
